...
(i) Some of employees may have the problem of drunk driving and drunk working, such as Nils Calixto for Car ID 1, Ingrid Barranco for Car ID 4 and so on.  
...
(ii) Car ID 3 visits Alberts Fine Clothing almost every day
...
(iii) The employee with Car ID 9 drives the long distance from the company to shop at Bean There Done That almost every day.
![](Images/4.png)   
...
(iv) Car ID 21, 22 and 34 all went to the museum on Saturday.
...
(v) Isia Vann with car ID 16 will go to Frydos Autosupply n More everyday.
![](Images/8.png)
