...
CC1$date <- as.Date(CC1$date, "%m/%d/%Y")
CC1$day <- as.factor(get_day(CC1$date))
head(CC1)
```
...
layout(title ='Most popular location of loyalty card transaction')
fig
```
